...
<template>  
  <div class="d-inline-block align-middle">
    <button
      ...
      :aria-label="btnTitle"
      type="button"
      @keyup.enter="() => { enableAllCardsTabIndexDisableAllCardsChildrenAndFilterableTabIndex(); emitClose(); }"
      @click="() => { enableAllCardsTabIndexDisableAllCardsChildrenAndFilterableTabIndex(); emitClose(); }"
