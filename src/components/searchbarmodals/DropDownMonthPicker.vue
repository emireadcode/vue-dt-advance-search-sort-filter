...
let 
  monthpickerarray = shallowRef<DropdownMonthPickerType>(),
  previous = {r: -1, c: -1}
;

function selectMonthAndEmitSignal(rindex: number, cindex: number) {
  if(
    (monthpickerarray.value as DropdownMonthPickerType)[rindex][cindex].status === 'ENABLE'
  ) {
    if(previous.r !== -1 && previous.c !== -1) {
      (monthpickerarray.value as DropdownMonthPickerType)[previous.r][previous.c].selected = 'DESELECTED';
    }
    ...
    (monthpickerarray.value as DropdownMonthPickerType)[rindex][cindex].selected === 'DESELECTED'? 'SELECTED' : 'DESELECTED';
...
function fillMonthPickerArray() {
  ...
  ;
  if(jumptoweek.rangeselectionparams.excludedates && jumptoweek.rangeselectionparams.rangefirstselection.date && jumptoweek.rangeselectionparams.rangelastselection.date) {
    if(jumptoweek.rangeselectionparams.rangefirstselection.year === jumptoweek.rangeselectionparams.rangelastselection.year) {
      if(jumptoweek.rangeselectionparams.rangefirstselection.month === jumptoweek.rangeselectionparams.rangelastselection.month) {
        ...
        if(jumptoweek.rangeselectionparams.rangefirstselection.month > jumptoweek.rangeselectionparams.rangelastselection.month) {
          for(let m=jumptoweek.rangeselectionparams.rangelastselection.month; m<=jumptoweek.rangeselectionparams.rangefirstselection.month; m++) {
            (vc as VisibleCalendarType['selections'])[
              jumptoweek.rangeselectionparams.rangefirstselection.year
            ].months = {
              ...(vc as VisibleCalendarType['selections'])[
          ...
          for(let m=jumptoweek.rangeselectionparams.rangefirstselection.month; m<=jumptoweek.rangeselectionparams.rangelastselection.month; m++) {
            (vc as VisibleCalendarType['selections'])[
              jumptoweek.rangeselectionparams.rangefirstselection.year
            ].months = {
              ...(vc as VisibleCalendarType['selections'])[
      ...
      if(jumptoweek.rangeselectionparams.rangefirstselection.year > jumptoweek.rangeselectionparams.rangelastselection.year) {
        for(let y=jumptoweek.rangeselectionparams.rangelastselection.year; y<=jumptoweek.rangeselectionparams.rangefirstselection.year; y++) {
        ...
        for(let y=jumptoweek.rangeselectionparams.rangefirstselection.year; y<=jumptoweek.rangeselectionparams.rangelastselection.year; y++) {
          if((vc as VisibleCalendarType['selections'])) {
            if(!(y in (vc as VisibleCalendarType['selections']))) {
              (vc as VisibleCalendarType['selections']) = {
                ...(vc as VisibleCalendarType['selections']),
        ...
        (monthpickerarray.value as DropdownMonthPickerType)[row] = {
          ...
          [col]: {
            ...
            status: jumptoweek.from === 'DAYS-MONTHS-YEARS'? (
              (
                (props.year in (
                  jumptoweek.selections as VisibleCalendarType['selections']
                ))
                &&
                i in (
                  jumptoweek.selections as VisibleCalendarType['selections']
...
<template>
  <div class="d-block h-100">
    ...
    >
      <template v-for="(row, rindex) in (monthpickerarray as DropdownMonthPickerType)">
        <template v-for="(col, cindex) in row">
          ...
          >
            <label
              ...
              class="w-100"
              style="float: left;"
              :style="jumptoweek.from === 'DD-MM-YYYY'? 'line-height: 3.8em; height: 3.8em;' : 'line-height: 4.565em; height: 4.565em;'"
            >
              <input
                @keypress.enter.stop=""
                @click.stop=""
