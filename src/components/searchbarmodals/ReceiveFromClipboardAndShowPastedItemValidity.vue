...
import { nextTick, triggerRef, inject, type ShallowRef, ref, shallowRef, } from "vue";
                            ...
                            >
                              <div class="flex-fill p-0 m-0 align-self-stretch">
                                <input
                                  ...
                                  class="w-100"
                                  v-model="item[0]"
                                  style="border-radius: 20px;padding: 8px;background-color: #ffcccb;"
                                />
                              </div>
                              <div
